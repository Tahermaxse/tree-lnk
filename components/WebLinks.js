...
const Links = () => {
  ...
  const descriptionText = descShow ? description : `Custom bio links for creatives who love coding. Made this first to use for my own weblinks.`
